            ...
            <div
                ...
                <header className="pointer-events-auto flex items-center justify-between gap-6 w-full max-w-5xl rounded-full bg-white border border-[#050A10]/10 px-6 sm:px-8 py-2.5 shadow-xl shadow-black/5">
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            href="#charter"
                            className="hidden sm:inline-flex rounded-full bg-[#050A10] px-5 py-2 font-mono text-xs font-semibold uppercase tracking-wider text-white transition-all hover:bg-[#B38E5D]"
                        >
                            Book Flight
                        </a>
